...
const spellingVariantsMap: Record<string, string[]> = {
  ...
  'giro': ['jiro', 'hiro', 'giro'],
  'hiro': ['jiro', 'giro', 'hiro'],
  'eunjiro': ['yonjiro', 'eonjiro', 'yunjiro', 'unjiro', 'eungiro', 'yongiro', 'eunjiro'],
  'yonjiro': ['eunjiro', 'eonjiro', 'yunjiro', 'unjiro', 'yongiro', 'yonjiro'],
  'eonjiro': ['eunjiro', 'yonjiro', 'yunjiro', 'unjiro', 'eongiro', 'eonjiro'],
  'yunjiro': ['eunjiro', 'yonjiro', 'eonjiro', 'unjiro', 'yungiro', 'yunjiro'],
  'jose': ['hoze', 'jose'],
  'jesus': ['hesus', 'jesus'],
  'hesus': ['jesus', 'hesus'],
  'jaime': ['haime', 'jaime'],
